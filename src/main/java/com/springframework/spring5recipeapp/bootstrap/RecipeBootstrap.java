...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes(){
        ...
        //get UOMs
        Optional<UnitOfMeasure> eachUomOptinal= unitOfMeasureRepository.findByDescription("Each");

        if(!eachUomOptinal.isPresent()){
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<UnitOfMeasure> tableSpoonUomOptinal= unitOfMeasureRepository.findByDescription("Tablespoon");

        if(!tableSpoonUomOptinal.isPresent()){
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<UnitOfMeasure> teaSpoonUomOptinal= unitOfMeasureRepository.findByDescription("Teaspoon");

        if(!eachUomOptinal.isPresent()){
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<UnitOfMeasure> dashUomOptinal= unitOfMeasureRepository.findByDescription("Dash");

        if(!dashUomOptinal.isPresent()){
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<UnitOfMeasure> pintUomOptinal= unitOfMeasureRepository.findByDescription("Pint");
